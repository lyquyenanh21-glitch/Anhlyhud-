-- ==========================================
-- THƯ VIỆN UI TỰ TẠO (THAY CHO LOADSTRING)
-- ==========================================
local Library = {}
local PlayerGui = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "AnhLyHub_UI"
...
TitleBar.Text = "anhlyhud - Blox Fruit"
...
local function updateCanvas()
    local absSize = layout.AbsoluteContentSize.Y
    scroll.CanvasSize = UDim2.new(0, 0, 0, absSize + 20)
end
...
tabObj.AddDropdown = function(id, setting)
    ...
    local proxy = {
        ...
        OnChanged = function(_, fn) frame.ExtraCallback = fn end,
        GetNewList = function(_, list) end
    }
    return proxy
end
...
function Library:SetTheme(theme) end
...
-- ==========================================
-- SỬA LỖI UI - CHÈN VÀO ĐẦU FILE
local PlayerGui = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
local Library = {Notify = function(t) game:GetService("StarterGui"):SetCore("SendNotification", t) end}
function Library:CreateWindow() return {AddTab = function() return {AddLeftGroupbox = function() return {AddToggle = function(_,s) s.Callback(s.Default) return {OnChanged=function(_,f)end} end, AddButton=function(_,c) pcall(c) end, AddDropdown=function() return {OnChanged=function(_,f)end} end, AddSlider=function() return {OnChanged=function(_,f)end} end, AddLabel=function()return{}end} end, AddRightGroupbox=function() return {} end} end} end end
local Window = Library:CreateWindow()
Tabs = {Info=Window:AddTab(), Main=Window:AddTab(), Sea=Window:AddTab(), Item=Window:AddTab(), Setting=Window:AddTab(), Status=Window:AddTab(), Stats=Window:AddTab(), Player=Window:AddTab(), Teleport=Window:AddTab(), Visual=Window:AddTab(), Fruit=Window:AddTab(), Raid=Window:AddTab(), Race=Window:AddTab(), Shop=Window:AddTab(), Misc=Window:AddTab()}
for _, tab in pairs(Tabs) do for i=1,5 do tab:AddLeftGroupbox("Loading...") end end
game:GetService("StarterGui"):SetCore("SendNotification", {Title="AnhLy Hub", Text="UI Fix Đã Áp Dụng! Đang tải chức năng...", Duration=3})
wait(1)
Sea1 = true
Sea2 = true
Sea3 = true
...
Tabs.Info:AddButton({
    ["Title"] = "máy chủ của lyquyenanh21",
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://discord.gg/fYkARJHF8"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "anhlyhud",
    ["Description"] = "tiktok",
    ["Callback"] = function()
        setclipboard(tostring("tiktok:@anh.vip.pro.fruits"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "anhlyhud",
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("anh.vip.pro.fruits"))
    end
})
...
Tabs.Info:AddParagraph({
    ["Title"] = "Cấp Nhắt",
    ["Description"] = "Tôi sẽ cập nhập nhiều tính năng hơn trong tương lai"
})
Tabs.Info:AddParagraph({
...
-- ========== AUTO RAID PIRATE ==========
Tabs.Main:AddSection("Farm Hải Tặc Pháo đài")
...
-- ===============================================================
print('✅ anhlyhud - Tất cả tính năng đã được load!')
